...
public class finalJob implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "finalJob.log");
	}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger
			.getLogger(finalJob.class);
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(finalJob.this, new Object[] { e,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = finalJob.class.getClassLoader()
					.getResourceAsStream(
							"projectfinal/finaljob_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = finalJob.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : finalJob");
		}
...
/************************************************************************************************
 * 25855 characters generated by Talend Cloud Data Management Platform on the 15
 * novembre 2018 15:27:23 CET
 ************************************************************************************************/
