...
package projectfinal.finaljob_0_1;
...
public class finalJob implements TalendJob {
	static {System.setProperty("TalendJob.log", "finalJob.log");}
	private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(finalJob.class);
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String projectName = "PROJECTFINAL";
 ...
 */
    ...
    public static void main(String[] args){
        ...
        int exitCode = finalJobClass.runJobInTOS(args);
	        if(exitCode==0){
		        log.info("TalendJob: 'finalJob' - Done.");
	        }
    ...
    public int runJobInTOS(String[] args) {
        ...
        for (String arg : args) {
        	...
        	log.info("TalendJob: 'finalJob' - Start.");
        ...
        try {
            ...
            java.io.InputStream inContext = finalJob.class.getClassLoader().getResourceAsStream("projectfinal/finaljob_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = finalJob.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     24881 characters generated by Talend Cloud Data Management Platform 
 *     on the 15 novembre 2018 15:33:33 CET
 ************************************************************************************************/